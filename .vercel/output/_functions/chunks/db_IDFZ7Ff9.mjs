...
import { c as createInvalidVariablesError, g as getEnv$1, s as setOnSetGetEnv } from './runtime_oaVS4q5Z.mjs';
...
const schema$1 = { user, message, session, account, verification };

const schema = {"SECRET_DATABASE_URL":{"context":"server","access":"secret","type":"string"},"SECRET_DATABASE_TOKEN":{"context":"server","access":"secret","type":"string"},"BETTER_AUTH_URL":{"context":"client","access":"public","type":"string"}};
...
setOnSetGetEnv(() => {
	SECRET_DATABASE_URL = _internalGetSecret("SECRET_DATABASE_URL");
SECRET_DATABASE_TOKEN = _internalGetSecret("SECRET_DATABASE_TOKEN");

});
let SECRET_DATABASE_URL = _internalGetSecret("SECRET_DATABASE_URL");
let SECRET_DATABASE_TOKEN = _internalGetSecret("SECRET_DATABASE_TOKEN");
...
const db = drizzle(dialect, { schema: schema$1 });

export { db as d, message as m, user as u };
